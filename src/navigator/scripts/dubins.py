...
def dubins_path_planning(sx, sy, syaw, ex, ey, eyaw, c):
	...
	lpx, lpy, lpyaw, mode, clen, pathlength = dubins_path_planning_from_origin(
		lex, ley, leyaw, c)
	...
	return px, py, pyaw, mode, clen, pathlength
...
def main():
	...
	px, py, pyaw, mode, clen, pathlength = dubins_path_planning(start_x, start_y, start_yaw,
